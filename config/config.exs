...
config :g3, G3Web.Endpoint,
  ...
  render_errors: [
    formats: [html: G3Web.ErrorHTML, json: G3Web.ErrorJSON],
    layout: false
  ],
  pubsub_server: G3.PubSub,
  live_view: [signing_salt: "HZQyastD"]
...
config :g3, G3.Mailer, adapter: Swoosh.Adapters.Local
